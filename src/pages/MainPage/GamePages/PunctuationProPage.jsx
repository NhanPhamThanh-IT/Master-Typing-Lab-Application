...
/**
 * PunctuationProPage - Page for playing the Punctuation Pro typing game
 */
const PunctuationProPage = () => {
    ...
    // Get the game data
    const game = GAMES_DATA.find(game => game.id === 'punctuation-pro');
...
export default PunctuationProPage;
