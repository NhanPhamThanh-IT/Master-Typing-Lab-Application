...
/**
 * WordMasterPage - Page for playing the Word Master typing game
 */
const WordMasterPage = () => {
    ...
    // Get the game data
    const game = GAMES_DATA.find(game => game.id === 'word-master');
