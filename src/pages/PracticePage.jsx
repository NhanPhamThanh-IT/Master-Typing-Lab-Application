...
const PracticeSettings = lazy(() => import('@components/practice/PracticeSettings'));
const StatsBar = lazy(() => import('@components/practice/StatsBar'));
const TextDisplay = lazy(() => import('@components/practice/TextDisplay'));
const TypingArea = lazy(() => import('@components/practice/TypingArea'));
const ActionButtons = lazy(() => import('@components/practice/ActionButtons'));
const ResultsPanel = lazy(() => import('@components/practice/ResultsPanel'));
